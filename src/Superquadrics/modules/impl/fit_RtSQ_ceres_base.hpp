...
#include <math.h>
#include "../fit_RtSQ_ceres_base.h"
#include "../superquadric_formulas.h"


////////////////////////////////////////////////////////////////////////////////
template<typename PointT, typename MatScalar>
sq::RtSQFittingCeresBase<PointT, MatScalar>::RtSQFittingCeresBase(const SuperquadricParameters<MatScalar> parameters)
{
...
sq::RtSQFittingCeresBase<PointT, MatScalar>::fit(SuperquadricParameters<MatScalar>& parameters)
{
...
sq::RtSQFittingCeresBase<PointT, MatScalar>::SuperquadricCostFunctor::operator () (const T* const xvec, T* residual) const
{
	T   e1 = T(_prevs.e1),
		e2 = T(_prevs.e2),
		a  = T(_prevs.a),
	...
	residual[0] =  superquadric_function<T>(xyz_tr[0], xyz_tr[1], xyz_tr[2], e1, e2, a, b, c);
	return (true);
}
